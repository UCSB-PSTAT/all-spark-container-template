...
The latest version of this container can be obtained by running `podman pull registry.cloud.college.ucsb.edu/ucsb/<image>:latest`
...
* Update the <course> and <image> text in the section above. 
